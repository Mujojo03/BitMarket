...
export function Navbar() {
  ...
  // Derive isSeller from roles array
        ...
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          ...
          <div className="flex items-center gap-4 ml-4">
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent
                side="right"
                className="bg-dark text-white border-l border-gray-800 w-[300px] sm:w-[350px]"
              >
                <div className="flex flex-col h-full">
                  ...
                  <div className="mt-auto pt-6">
                    <Button
                      className="w-full bg-bitcoin hover:bg-bitcoin/90 text-black font-medium px-4 py-2 rounded-md"
                      onClick={() => {
...
//                   <Button variant="ghost" className="relative h-8 w-8 rounded-full">
//                     <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-700 text-white">
//                       {user.username?.charAt(0) || user.username?.charAt(0) || user.email?.charAt(0) || "U"}
//                     </div>
//                   </Button>
//                 </DropdownMenuTrigger>
//                 <DropdownMenuContent className="w-56 bg-gray-800 border-gray-700" align="end" forceMount>
