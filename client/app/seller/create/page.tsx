...
export default function SellerCreatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Error",
        description: err?.message || "Failed to become a seller. Please try again.",
      })
    } finally {
  ...
  if (step === 2) {
    return (
      <>
        <Head>
          <title>Seller Success | SatSoko</title>
        </Head>
        <div className="container px-4 py-12 md:px-6 md:py-24 max-w-3xl">
          <Card className="bg-gray-800 border-gray-700">
            ...
            <CardContent className="text-center space-y-4">
              <p>
                Your seller account has been created successfully. You can now start
                listing products and earning Bitcoin.
              </p>
  ...
  return (
    <>
      <Head>
        <title>Become a Seller | SatSoko</title>
      </Head>
      <div className="container px-4 py-8 md:px-6 md:py-12 max-w-3xl">
        <Card className="bg-gray-800 border-gray-700">
          <CardHeader>
            ...
            <CardDescription>
              Click submit below to become a seller on SatSoko
            </CardDescription>
          </CardHeader>
          <CardContent>
