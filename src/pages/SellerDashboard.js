...
const SellerDashboard = () => {
  ...
  const recentOrders = [
    ...
    },
    {
      ...
      status: "shipped",
      date: "2024-01-14",
      image: "https://via.placeholder.com/60x60?text=Mask",
    },
    {
      id: "ORD-003",
      ...
      status: "delivered",
      date: "2024-01-13",
      image: "https://via.placeholder.com/60x60?text=Basket",
    },
  ]
  ...
  const products = [
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/200x200?text=Mask",
      stock: 3,
      sales: 8,
      rating: 4.8,
      status: "active",
    },
    {
      ...
      image: "https://via.placeholder.com/200x200?text=Basket",
      stock: 0,
      sales: 15,
      rating: 4.7,
      status: "out_of_stock",
